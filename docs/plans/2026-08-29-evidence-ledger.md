...
**EL-10/EL-11/EL-12 vs. old resume (fintech internship at Dynamicore Strategies, Front-End Developer Intern):**

The old `.tex` resume (lines 69–75) describes this role as: "Built responsive
dashboards, investment marketplace, loan management, virtual trading platform,
gamified learning modules." The portfolio's `experience-info.ts` (EL-11)
describes the same role in more detail and with more current phrasing: a
fintech platform covering portfolio tracking, investment explorer, live market
data, loan comparison, KYC, and gamified learning.

The portfolio version is more detailed and current, and is the one to use as
the primary source. That said, the old resume's "investment marketplace" and
"virtual trading platform" phrasing is directionally consistent with the
portfolio's "investment explorer" and "portfolio tracking" claims (EL-11) and
may be blended into the final resume bullet if it reads more naturally,
provided no claim is introduced that isn't already backed by EL-11/EL-12
(e.g., "virtual trading platform" should only be used if it is understood as
describing the same portfolio-tracking/investment-explorer functionality, not
as an additional unverified feature).
